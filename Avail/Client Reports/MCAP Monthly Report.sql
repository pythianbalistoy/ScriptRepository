...
SELECT c.company_name,
       ...
       (SELECT Max(to_char(date_ENTRY,'DD-MON-YYYY'))
              ...
              AND date_ENTRY >=  to_date('10-Sep-2011','dd-MON-yyyy')
              AND date_ENTRY < to_date('1-Oct-2011','dd-MON-yyyy')) last_date_updated_month,
...
where
     ...
     AND m.p_id = d.p_id
     AND m.client_id = 4680 
     AND d.date_ENTRY >=  to_date('10-Sep-2011','dd-MON-yyyy')
     AND d.date_ENTRY < to_date('1-Oct-2011','dd-MON-yyyy')
...
order by date_created;
 ...
 Select *
 From track.clients
 where lower(company_name) like '%mcap%'
