...
SELECT c.company_name,
       ...
       (SELECT Max(to_char(date_ENTRY,'DD-MON-YYYY'))
              ...
              AND date_ENTRY >=  to_date('01-MAY-2011','dd-MON-yyyy')
              AND date_ENTRY < to_date('1-JUNE-2011','dd-MON-yyyy')) last_date_updated_month,
...
where
     ...
     AND m.p_id = d.p_id
     AND m.client_id =6940 -- JPAY
     AND d.date_ENTRY >=  to_date('01-MAY-2011','dd-MON-yyyy')
     AND d.date_ENTRY < to_date('1-JUNE-2011','dd-MON-yyyy')
...
order by 1,12,2 ;
 ...
 Select *
 From track.clients
 where lower(company_name) like '%jpay%'
