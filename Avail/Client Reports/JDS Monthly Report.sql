...
SELECT c.company_name,
       ...
       (SELECT Max(to_char(date_ENTRY,'DD-MON-YYYY'))
              ...
              AND date_ENTRY >=  to_date('01-Jan-2012','dd-MON-yyyy')
              AND date_ENTRY < to_date('1-Feb-2012','dd-MON-yyyy')) last_date_updated_month,
...
where
     ...
     AND m.p_id = d.p_id
     AND m.client_id in(861,171)     -- JDS and JDS-SQL
     AND d.date_ENTRY >=  to_date('1-Mar-2012','dd-MON-yyyy')
     AND d.date_ENTRY < to_date('1-Apr-2012','dd-MON-yyyy')
